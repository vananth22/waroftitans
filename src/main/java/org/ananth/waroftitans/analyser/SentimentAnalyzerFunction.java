...
public class SentimentAnalyzerFunction implements
    ...
    public SentimentAnalyzerFunction() {
        ...
        //System.setProperty("STS", "10");

        props.setProperty("annotators", "tokenize, ssplit, parse, sentiment,lemma, ner,regexner,pos");
        props.put("regexner.mapping", "edu/stanford/nlp/entity/entity-regexner.txt");
        this.pipeline = new StanfordCoreNLP(props);

    }

    @Override
    public SentimentBean apply (
                                String tweeetText) {
    ...
    private String sentimentScaleConverter (
                                            int sentiment) {
        switch (sentiment) {
            case 0:
