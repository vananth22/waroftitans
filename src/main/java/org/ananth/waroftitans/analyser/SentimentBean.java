...
public class SentimentBean implements Serializable {
	...
	public SentimentBean(final String text, final String sentiment,
	...
	public String toString() {
		// return "TweetWithSentiment [line=" + text + ", cssClass=" + sentiment
		// + "]";
		return this.sentiment + "=" + this.sentimentScore;
	}
